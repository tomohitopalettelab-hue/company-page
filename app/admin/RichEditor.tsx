...
export default function RichEditor({ value, onChange }: RichEditorProps) {
  ...
  return (
    <div className="border border-slate-100 rounded-[2rem] bg-white overflow-hidden focus-within:ring-4 focus-within:ring-blue-50 focus-within:border-blue-400 transition-all">
      {/* ツールバー */}
